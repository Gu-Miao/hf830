...
var NgbSecurity = new function __NgbSecurity()
{
	...
	var _timeout;
	var _header;
	var _IV3G7WPG16CMU11C = new Array();
	...
	this.InitData = function()
	{
		...
		_IV3G7WPG16CMU11C.length = 0;
	}
	
	this.AddData = function( _467YK3JALQB9W4UP )
	{
		if ( typeof( _url ) != 'undefined' && typeof( _timer ) != 'undefined' )
			return;
			
		_IV3G7WPG16CMU11C[ _IV3G7WPG16CMU11C.length ] = _467YK3JALQB9W4UP;
	}
	...
	{
		if ( _IV3G7WPG16CMU11C.length == 0 || typeof( handler ) == 'undefined' )
			throw Exception;
	...
	this.HashString = function( _T4QTVFIA268B16A3 )
	{
		var hashString = NgbHash.HMAC_SHA256_MAC2( "4E65786F6E55736572", _T4QTVFIA268B16A3 );
		return hashString;
	}
	
	this.HashString2 = function( _BBX44PC9BBYU31QL, _T4QTVFIA268B16A3, _IETOK6MIRXK8LGI1 )
	{
		var hashString = _BBX44PC9BBYU31QL + NgbHash.HMAC_SHA256_MAC( _IETOK6MIRXK8LGI1, NgbHash.HMAC_SHA256_MAC2( "4E65786F6E55736572", _T4QTVFIA268B16A3 ));
		return hashString;
	}
	...
	var ProcessEncrypt = function()
	{
		...
		var _467YK3JALQB9W4UP = '';
		
		if ( typeof( _hash ) != 'undefined' )
			_467YK3JALQB9W4UP = _hash + '\\';
			
		for ( var i = 0; i < _IV3G7WPG16CMU11C.length; i++ )
		{
			_467YK3JALQB9W4UP += NgbRSA.utf8base64encode( _IV3G7WPG16CMU11C[ i ] );
			
			if ( i < _IV3G7WPG16CMU11C.length - 1 )
				_467YK3JALQB9W4UP += '\\';
		}
		
		var val = EncryptString( key, _467YK3JALQB9W4UP );
		_IV3G7WPG16CMU11C.length = 0;
	...
	var EncryptString = function( key, _L1CAQ4LOG83JNJD2 )
	{
		...
		var a = new Array();
		var sl = _L1CAQ4LOG83JNJD2.length;
		
		var i = 0;
		while ( i < sl )
		{
			a[ i ] = _L1CAQ4LOG83JNJD2.charCodeAt( i );
			i++;
		}
...
var NgbLogin = new function __NgbLogin()
{
	...
	var _header;
	var _hashKey;
	var __GRGLV6AY5JFYWR8Q;
	var __FLPMXYBD776S6Q94;
	var _isLogin2;
	var _callBackMethod;
	var _isKeepLogin = '0';
	...
	var _QHEOST66NFSWG06P;
	
	var _isInvalidPasswordHashKeyString = false;
    var _isFailover = false;
    var _isSLogin = '0';
	
	this.SetData = function( _GRGLV6AY5JFYWR8Q, _FLPMXYBD776S6Q94, accesscode, strRedirect, isSLogin )
	{
		__GRGLV6AY5JFYWR8Q = _GRGLV6AY5JFYWR8Q;
		__FLPMXYBD776S6Q94 = _FLPMXYBD776S6Q94;
    ...
    this.SLogin = function (_GRGLV6AY5JFYWR8Q, _FLPMXYBD776S6Q94, accesscode, strRedirect) {
        NgbLogin.SetData(_GRGLV6AY5JFYWR8Q, _FLPMXYBD776S6Q94, accesscode, strRedirect, '1');
        _isLogin2 = false;

        if (_GRGLV6AY5JFYWR8Q.indexOf('@') != -1 )
        {
            var arrEmail = _GRGLV6AY5JFYWR8Q.split('@');

            if (arrEmail.length != 2 || arrEmail[0] == '' || arrEmail[1] == '' || _GRGLV6AY5JFYWR8Q.indexOf(' ') != -1 )
            {
                alert('아이디를 확인해 주세요.');
                return;
            }
            ...
            _isFailover = false;
            _QHEOST66NFSWG06P = _GRGLV6AY5JFYWR8Q;
            AuthSystem.GetPasswordHashKey(_GRGLV6AY5JFYWR8Q, NgbLogin.HashHandler);
    ...
    this.Login = function (_GRGLV6AY5JFYWR8Q, _FLPMXYBD776S6Q94, accesscode, strRedirect)
	{
		NgbLogin.SetData( _GRGLV6AY5JFYWR8Q, _FLPMXYBD776S6Q94, accesscode, strRedirect);
		_isLogin2 = false;
	...
	this.Login2 = function( _GRGLV6AY5JFYWR8Q, _FLPMXYBD776S6Q94, callBackMethod, accesscode )
	{
        ...
        NgbLogin.SetData(_GRGLV6AY5JFYWR8Q, _FLPMXYBD776S6Q94, accesscode);
		_isLogin2 = true;
	...
	{
		_GRGLV6AY5JFYWR8Q = __GRGLV6AY5JFYWR8Q;
		_FLPMXYBD776S6Q94 = __FLPMXYBD776S6Q94;
		accesscode = _accesscode;
		strRedirect = _strRedirect;
        isSLogin = _isSLogin;
		
		var strDomain = NgbLogin.GetLoginURL();
		_GRGLV6AY5JFYWR8Q = NgbString.Trim( _GRGLV6AY5JFYWR8Q );
		_FLPMXYBD776S6Q94 = NgbString.Trim( _FLPMXYBD776S6Q94 );
		...
		if ( _GRGLV6AY5JFYWR8Q == '' || _GRGLV6AY5JFYWR8Q.indexOf( ' ' ) != -1 )
		{
			alert( '아이디를 입력해 주세요.' );
			return;
		}
		else if ( _FLPMXYBD776S6Q94 == '' )
		{
			alert( '비밀번호를 입력해 주세요.' );
			return;
		}
		...
		try
		{
			...
			NgbSecurity.AddData( _GRGLV6AY5JFYWR8Q );
			NgbSecurity.AddData( _GRGLV6AY5JFYWR8Q.indexOf( '@' ) != -1 ? NgbSecurity.HashString2( _header, _FLPMXYBD776S6Q94, _hashKey ) : _FLPMXYBD776S6Q94 );
            NgbSecurity.AddData( NgbHash.SHA256_hash(_FLPMXYBD776S6Q94));
